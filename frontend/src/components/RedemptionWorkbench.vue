...
import { CircleAlert, CircleCheck, Download, RefreshCw } from 'lucide-vue-next'
...
const props = withDefaults(defineProps<{
  ...
  storageKey: 'aether-pool.redeem-job',
})
...
function storeRedeemJob(job: RedeemJob) {
  try {
    localStorage.setItem(props.storageKey, JSON.stringify({ id: job.id }))
  } catch {
